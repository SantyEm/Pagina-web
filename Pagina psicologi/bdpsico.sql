...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='Tabla almacena la información detallada sobre el historial educativo de cada paciente, incluyendo su adaptación, relaciones con docentes y compañeros, repitencia escolar, y cambios en escuelas y maestros.';
/*!40101 SET character_set_client = @saved_cs_client */;
